angular.module('app', ['ngResource', 'ui.router', 'LocalStorageService']);
...
angular.module('app').config(function ($stateProvider, $urlRouterProvider, $httpProvider) {
    ...
    $stateProvider
        ...
        .state('register', { url: '/register', templateUrl: '/templates/register/register.html', controller: "Controller" })
